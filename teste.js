import { GoogleGenerativeAI } from "@google/generative-ai";
        ...
        document.getElementById('generateButton').addEventListener('click', async () => {
            ...
            if (!userInput.trim() && !imageFile && !docFile) { // Verifica se o input, a imagem e o documento estão vazios
                document.getElementById('output').value = "Por favor, insira detalhes para sua apresentação, faça upload de uma imagem ou de um documento.";
                return;
            }
            ...
            if (docFile) {
                try {
                    ...
                    document.getElementById('output').value = "Erro ao processar o documento.";
                    return;
                }
            }
